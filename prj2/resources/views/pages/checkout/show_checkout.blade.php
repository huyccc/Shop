					...
					<section id="cart_items">
                        <div class="container">
                            ...
                            <div class="register-req">
                                <p>Vui lòng kiểm tra lại thông tin giỏ hàng, thông tin vận chuyển và người mua hàng để chúng tôi có thể giao cho bạn chính xác nhất</p>
                            </div><!--/register-req-->
                                        ...
                                        <div class="bill-to">
                                            ...
                                            <div class="form-one">
                                                <form action="{{ URL::to('/save-checkout-customer') }}" method="POST">
                                                    ...
                                                    <textarea name="shipping_notes" placeholder="Ghi chú cho đơn hàng của bạn" rows="10"></textarea>
							...
							<h4 style="margin-top: 40px; margin-bottom: 40px; font-size: 20px">Chọn phương thức thanh toán</h4>
							<form action="{{ URL::to('/order-place') }}" method="POST">
								@csrf
                            <div class="payment-options">
                                    <span>
                                        <label><input name="payment_method" value="1" type="checkbox"> Thẻ ATM</label>
                                    </span>
                                    <span>
                                        <label><input name="payment_method" value="2" type="checkbox"> Nhận tiền mặt</label>
									</span>
									<span>
                                        <label><input name="payment_method" value="3" type="checkbox"> Bằng thẻ ghi nợ</label>
                                    </span>
                                    {{-- <span>
